...
func _on_pressed():
	CharacterHandler.currentCharacter = CharacterHandler.Character.SELENA
	CharacterHandler.currentCharacterSwitched.emit()
	
	## TEMP
	acceleration_field.set_text(str(TestCharacterStats.selena_acceleration))
	max_speed_field.set_text(str(TestCharacterStats.selena_max_speed))
	jump_field.set_text(str(TestCharacterStats.selena_jump_power))
	brake_field.set_text(str(TestCharacterStats.selena_brake_power))
