...
func _on_pressed():
	CharacterHandler.currentCharacter = CharacterHandler.Character.ADIEN
	CharacterHandler.currentCharacterSwitched.emit()
	
	## TEMP
	acceleration_field.set_text(str(TestCharacterStats.adien_acceleration))
	max_speed_field.set_text(str(TestCharacterStats.adien_max_speed))
	jump_field.set_text(str(TestCharacterStats.adien_jump_power))
	brake_field.set_text(str(TestCharacterStats.adien_brake_power))
